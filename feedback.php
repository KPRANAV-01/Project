            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                     ...
                     <h1 class="h1 mb-2 text-gray-800"><i class="fa fa-home"></i> Feedback</h1>
                    </form>
    ...
    <div class="content">
      <form action="#">
        <div class="user-details">
          ...
          <div class="input-box">
            <span class="details">Give your feedback</span>
            <input type="text" placeholder="Type your feedback" required>
          </div>
