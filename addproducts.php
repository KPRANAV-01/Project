            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                      ...
                      <h1 class="h2 mb-2 text-gray-800"><i class="fab fa-product-hunt"></i> Add Products</h1>
                    </form>
             ...
             <div class="row">
                 <div class="col-sm-6">
                    <img src="img/newpro.png" alt="" style="height: 75%;" width="80%;">
                 </div>
                 <div class="col-sm-6">
                           <form class="user">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="Product Quantity">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="exampleRepeatPassword" placeholder="Product Price">
                                    </div>
                                </div>
                                <br>
                                <br>
